...
for mm in range( 2 ):
	...
	for kk in range( 3 ):
		...
		dat = pds.read_csv( '/home/xkchen/%s_%s-band_photo-z-match_rgi-common_pk-offset_BCG-pos_cat.csv' % (cat_lis[mm], band_str),)
...
for mm in range( 2 ):
	...
	for kk in range( 3 ):
		...
		d_file = '/home/xkchen/project/tmp/mask_img/photo-z_mask_%s_ra%.3f_dec%.3f_z%.3f.fits'
		out_file = '/home/xkchen/project/tmp/resamp_img/photo-z_resamp_%s_ra%.3f_dec%.3f_z%.3f.fits'
...
for kk in range( 3 ):
	...
	offset_file = '/home/xkchen/figs/random_%s-band_ra%.3f_dec%.3f_z%.3f_star-pos-offset.csv'
