...
## fixed rich bin
# pre_path = '/home/xkchen/mywork/ICL/code/rich_based_cat/tmp_age_SBs/'
# pre_BG_path = '/home/xkchen/mywork/ICL/code/rich_based_cat/tmp_age_BGs/'
...
pre_path = '/home/xkchen/mywork/ICL/code/rich_based_cat/tmp_mass_SBs/'
pre_BG_path = '/home/xkchen/mywork/ICL/code/rich_based_cat/tmp_mass_BGs/'
...
def surf_M_func():
	...
	for mm in range( 2 ):
		...
		band_str = 'rig'
		c_inv = False
		for kk in (0,2,1): # r,i band based mass estimate
		...
		M_cov_file = BG_path + '%s_%s-band-based_aveg-jack_surf-mass_cov_arr.h5' % (cat_lis[mm], band_str)
...
legend_0 = plt.legend( [ fig_name[1] + ',at fixed $ \\lambda $', fig_name[0] + ',at fixed $\\lambda$' ], loc = 6, frameon = False,)
