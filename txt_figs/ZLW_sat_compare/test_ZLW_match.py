...
#. central galaxies
cen_dat = np.loadtxt('/home/xkchen/figs/sat_cat_ZLW/ZLW_sat/WH15_chenxk_age.dat')
...
# np.savetxt('/home/xkchen/figs/sat_cat_ZLW/sql_table/cen_galx_cat.dat', tmp_arr, fmt = ('%.0f', '%.5f', '%.5f'),)


#. satellite galaxies
sat_dat = np.loadtxt('/home/xkchen/figs/sat_cat_ZLW/ZLW_sat/clustmem_chenxk_age.dat')
...
# 	np.savetxt('/home/xkchen/figs/sat_cat_ZLW/sql_table/sat_galx_cat_%d.dat' % tt, tmp_arr, fmt = ('%.0f', '%.5f', '%.5f'),)


###... combine color catalog with position, centric distance
sql_cen_dat = pds.read_csv('/home/xkchen/figs/sat_cat_ZLW/sql_table/cen_gax_mag.csv', skiprows = 1)
...
out_data.to_csv( '/home/xkchen/figs/sat_cat_ZLW/ZLW_cat_clust_sql_match_cat.csv' )
...
sat_sql_dat = pds.read_csv('/home/xkchen/figs/sat_cat_ZLW/sql_table/sat_gax_mag_0.csv', skiprows = 1)
...
for tt in range( 1,24 ):
	...
	tt_dat = pds.read_csv('/home/xkchen/figs/sat_cat_ZLW/sql_table/sat_gax_mag_%d.csv' % tt, skiprows = 1)
...
out_data = pds.DataFrame( fill )
out_data.to_csv( '/home/xkchen/figs/sat_cat_ZLW/ZLW_cat_sat_sql_match_cat.csv' )
...
sat_dat = pds.read_csv( '/home/xkchen/figs/sat_cat_ZLW/ZLW_cat_sat_sql_match_cat.csv' )
...
for tt in range( N_Low ):
	...
	if tt < N_rep_dex:
		cc_ra_g, cc_dec_g, cc_z_g = clus_ra[ tt + N_Low ], clus_dec[ tt + N_Low ], clus_z[ tt + N_Low ]
