...
for ll in range( 2 ):
	...
	# XXX
	sub_img = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_sub-%d_img_pk-off.h5'
	sub_pix_cont = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_sub-%d_pix-cont_pk-off.h5'
	sub_sb = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_sub-%d_SB-pro_pk-off.h5'
	# XXX

	J_sub_img = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_jack-sub-%d_img_z-ref_pk-off.h5'
	J_sub_pix_cont = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_jack-sub-%d_pix-cont_z-ref_pk-off.h5'
	J_sub_sb = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_jack-sub-%d_SB-pro_z-ref_pk-off.h5'

	jack_SB_file = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_Mean_jack_SB-pro_z-ref_pk-off.h5'
	jack_img = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_Mean_jack_img_z-ref_pk-off.h5'
	jack_cont_arr = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_Mean_jack_pix-cont_z-ref_pk-off.h5'
...
# XXX
sub_img = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_tot-BCG-star-Mass_%s-band' % band_str + '_sub-%d_img.h5'
sub_pix_cont = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_tot-BCG-star-Mass_%s-band' % band_str + '_sub-%d_pix-cont.h5'
sub_sb = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_tot-BCG-star-Mass_%s-band' % band_str + '_sub-%d_SB-pro.h5'
# XXX

J_sub_img = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_tot-BCG-star-Mass_%s-band' % band_str + '_jack-sub-%d_img_z-ref.h5'
J_sub_pix_cont = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_tot-BCG-star-Mass_%s-band' % band_str + '_jack-sub-%d_pix-cont_z-ref.h5'
J_sub_sb = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_tot-BCG-star-Mass_%s-band' % band_str + '_jack-sub-%d_SB-pro_z-ref.h5'

jack_SB_file = '/home/xkchen/fig_tmp/pkoffset_stack/' + 'photo-z_match_tot-BCG-star-Mass_%s-band' % band_str + '_Mean_jack_SB-pro_z-ref.h5'
