...
for ll in range( 2 ):
	...
	dat = pds.read_csv( load + 'Pcen_lim_cat/' + '%s_gri-common_P-cen_lim_cat.csv' % cat_lis[ll] )
	...
	data.to_csv( load + 'Pcen_lim_cat/' + 'photo-z_match_%s_%s-band_gri-common_BCG-pos_cat_z-ref.csv' % (cat_lis[ll], band_str),)
...
for ll in range( 2 ):
	...
	## BCG position offset
	dat = pds.read_csv( load + 'Pcen_lim_cat/' + 
	...
	# XXX
	sub_img = load + 'Pcen_lim_stack/photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_sub-%d_img.h5'
	sub_pix_cont = load + 'Pcen_lim_stack/photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_sub-%d_pix-cont.h5'
	sub_sb = load + 'Pcen_lim_stack/photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_sub-%d_SB-pro.h5'
	# XXX

	J_sub_img = load + 'Pcen_lim_stack/photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_jack-sub-%d_img_z-ref.h5'
	J_sub_pix_cont = load + 'Pcen_lim_stack/photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_jack-sub-%d_pix-cont_z-ref.h5'
	J_sub_sb = load + 'Pcen_lim_stack/photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_jack-sub-%d_SB-pro_z-ref.h5'

	jack_SB_file = load + 'Pcen_lim_stack/photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_Mean_jack_SB-pro_z-ref.h5'
	jack_img = load + 'Pcen_lim_stack/photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_Mean_jack_img_z-ref.h5'
	jack_cont_arr = load + 'Pcen_lim_stack/photo-z_match_gri-common_' + cat_lis[ll] + '_%s-band' % band_str + '_Mean_jack_pix-cont_z-ref.h5'
