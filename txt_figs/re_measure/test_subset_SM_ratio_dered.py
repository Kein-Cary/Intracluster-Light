...
#. without aper_M correction for comparing
sub_ax1.plot( dt_eta_R[0]/ 1e3, dt_eta[0], ls = line_s[0], color = 'k', alpha = 0.45)
sub_ax1.plot( dt_eta_R[1]/ 1e3, dt_eta[1], ls = line_s[1], color = 'k', alpha = 0.45)
...
#. without aper_M correction for comparing
sub_ax2.plot( dt_eta_R[0]/ 1e3, dt_eta[0], ls = line_s[0], color = 'k', alpha = 0.45)
sub_ax2.plot( dt_eta_R[1]/ 1e3, dt_eta[1], ls = line_s[1], color = 'k', alpha = 0.45)
