...
if medi_calib:
	...
	### === ### subsamples divided by BCG stellar mass
	...
	lo_eta_R, lo_eta_M, lo_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['medi_ref_M/M_tot'] ), 
										np.array( eta_dat['medi_ref_M/M_tot-err'] ) )

	eta_dat = pds.read_csv( '/home/xkchen/figs/re_measure_SBs/SM_profile/' + 
							'%s_gri-band_corrected-aveg-M-ratio_to_total-sample%s.csv' % (cat_lis[1], dered_str),)
	hi_eta_R, hi_eta_M, hi_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['medi_ref_M/M_tot'] ), 
										np.array( eta_dat['medi_ref_M/M_tot-err'] ) )



	### === ### subsamples divided by BCG stellar mass within 20kpc (M20)
	...
	lo_M20_eta_R, lo_M20_eta_M, lo_M20_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['medi_ref_M/M_tot'] ), 
													np.array( eta_dat['medi_ref_M/M_tot-err']) )

	eta_dat = pds.read_csv( '/home/xkchen/figs/BCG_aper_M/uniform_M2L_SBs/surface_M/' + 
							'%s_gri-band_corrected-aveg-M-ratio_to_total-sample%s.csv' % (cat_lis_0[1], dered_str),)
	hi_M20_eta_R, hi_M20_eta_M, hi_M20_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['medi_ref_M/M_tot'] ), 
													np.array( eta_dat['medi_ref_M/M_tot-err']) )
	...
	eta_dat = pds.read_csv( '/home/xkchen/figs/Pcen_cut/surf_M/' + 
								'%s_gri-band_corrected-aveg-M-ratio_to_total-sample%s.csv' % (cat_lis[0], dered_str),)
	Pcen_lo_eta_R, Pcen_lo_eta_M, Pcen_lo_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['medi_ref_M/M_tot'] ), 
															np.array( eta_dat['medi_ref_M/M_tot-err'] ) )

	eta_dat = pds.read_csv( '/home/xkchen/figs/Pcen_cut/surf_M/' + 
								'%s_gri-band_corrected-aveg-M-ratio_to_total-sample%s.csv' % (cat_lis[1], dered_str),)
	Pcen_hi_eta_R, Pcen_hi_eta_M, Pcen_hi_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['medi_ref_M/M_tot'] ), 
															np.array( eta_dat['medi_ref_M/M_tot-err'] ) )
	...
	eta_dat = pds.read_csv( '/home/xkchen/figs/re_measure_SBs/SM_profile/' + 
							'%s_gri-band_corrected-aveg-M-ratio_to_total-sample%s.csv' % (cat_lis[0], dered_str),)
	lo_eta_R, lo_eta_M, lo_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['mean_ref_M/M_tot'] ), 
										np.array( eta_dat['mean_ref_M/M_tot-err'] ) )

	eta_dat = pds.read_csv( '/home/xkchen/figs/re_measure_SBs/SM_profile/' + 
							'%s_gri-band_corrected-aveg-M-ratio_to_total-sample%s.csv' % (cat_lis[1], dered_str),)
	hi_eta_R, hi_eta_M, hi_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['mean_ref_M/M_tot'] ), 
										np.array( eta_dat['mean_ref_M/M_tot-err'] ) )
	...
	eta_dat = pds.read_csv( '/home/xkchen/figs/BCG_aper_M/uniform_M2L_SBs/surface_M/' + 
							'%s_gri-band_corrected-aveg-M-ratio_to_total-sample%s.csv' % (cat_lis_0[0], dered_str),)
	lo_M20_eta_R, lo_M20_eta_M, lo_M20_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['mean_ref_M/M_tot'] ), 
													np.array( eta_dat['mean_ref_M/M_tot-err']) )

	eta_dat = pds.read_csv( '/home/xkchen/figs/BCG_aper_M/uniform_M2L_SBs/surface_M/' + 
							'%s_gri-band_corrected-aveg-M-ratio_to_total-sample%s.csv' % (cat_lis_0[1], dered_str),)
	hi_M20_eta_R, hi_M20_eta_M, hi_M20_eta_M_err = ( np.array( eta_dat['R'] ), np.array( eta_dat['mean_ref_M/M_tot'] ), 
													np.array( eta_dat['mean_ref_M/M_tot-err']) )
