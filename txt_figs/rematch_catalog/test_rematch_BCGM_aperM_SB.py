...
BG_path = '/home/xkchen/figs/extend_bcgM_cat/aperM_bin/BGs/'
path = '/home/xkchen/figs/extend_bcgM_cat/aperM_bin/SBs/'
...
def sub_SM_profile():
	...
	band_str = 'gri'
	out_path = '/home/xkchen/figs/extend_bcgM_cat/aperM_bin/SM_profile/'
	...
	for mm in range( 2 ):
		...
		E_dat = pds.read_csv( '/home/xkchen/figs/extend_bcgM_cat/aperM_bin/' + '%s_r-band_photo-z-match_rgi-common_cat_params.csv' % cat_lis[mm],)
...
def sub_SM_ratio():
	...
	out_path = '/home/xkchen/figs/extend_bcgM_cat/aperM_bin/SM_profile/'
	cat_path = '/home/xkchen/figs/extend_bcgM_cat/aperM_bin/'
...
##..
pre_BG_path = '/home/xkchen/figs/BCG_aper_M/uniform_M2L_SBs/BGs/'
...
plt.savefig('/home/xkchen/BG-sub-SB_compare.png', dpi = 300)
plt.close()
...
for kk in range( 3 ):
	...
	ax.plot( pre_low_r[kk], pre_low_sb[kk], ls = '--', color = 'b', alpha = 0.75, label = 'Low $ M_{\\ast} ^{BCG} \\mid \; \\lambda $',)
	ax.plot( pre_hi_r[kk], pre_hi_sb[kk], ls = '--', color = 'r', alpha = 0.75, label = 'High $ M_{\\ast} ^{BCG} \\mid \; \\lambda $',)

	ax.plot(nbg_low_r[kk], nbg_low_sb[kk], ls = '-', color = 'b', alpha = 0.75, label = fig_name[0] + '$ \\mid \; \\lambda$')
	ax.fill_between(nbg_low_r[kk], y1 = nbg_low_sb[kk] - nbg_low_err[kk], 
				y2 = nbg_low_sb[kk] + nbg_low_err[kk], color = 'b', alpha = 0.15,)

	ax.plot(nbg_hi_r[kk], nbg_hi_sb[kk], ls = '-', color = 'r', alpha = 0.75, label = fig_name[1] + '$ \\mid \; \\lambda$')
	ax.fill_between(nbg_hi_r[kk], y1 = nbg_hi_sb[kk] - nbg_hi_err[kk], 
				y2 = nbg_hi_sb[kk] + nbg_hi_err[kk], color = 'r', alpha = 0.15,)	

	ax.annotate( text = '%s band' % band[kk], xy = (0.80, 0.90), xycoords = 'axes fraction', fontsize = 15,)
	...
	plt.savefig('/home/xkchen/%s-band_BG-sub-SB_compare.png' % band[kk], dpi = 300)
	plt.close()	
