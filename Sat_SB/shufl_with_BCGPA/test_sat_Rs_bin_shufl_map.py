...
shufl_path = '/home/xkchen/figs/extend_bcgM_cat_Sat/shufl_with_BCG_PA/shufl_cat/'
out_path = '/home/xkchen/figs/extend_bcgM_cat_Sat/shufl_with_BCG_PA/map_cat/'
...
for pp in range( 3 ):
	...
	# for tt in range( 3 ):
		...
		for kk in range( 1 ):
			...
			##. original image cut information
			...
			##.
			out_shufl_file = ( out_path + 'frame-lim_Pm-cut_rich_%d-%d_%.2f-%.2fR200m_mem_%s-band_wBCG-PA_' 
								% ( bin_rich[pp], bin_rich[pp + 1], R_bins[tt], R_bins[tt + 1], band_str) + 'sat-shufl-%d_cat.csv',)[0]

			out_pos_file = ( out_path + 'frame-lim_Pm-cut_rich_%d-%d_%.2f-%.2fR200m_mem_%s-band_wBCG-PA_'
								% ( bin_rich[pp], bin_rich[pp + 1], R_bins[tt], R_bins[tt + 1], band_str) + 'sat-shufl-%d_origin-img_position.csv',)[0]

			out_Ng_file = ( out_path + 'frame-lim_Pm-cut_rich_%d-%d_%.2f-%.2fR200m_mem_%s-band_wBCG-PA_' 
