...
### ========= ### zref_img cut (after pixel resampling)
##... but not applied BCG mask during satellite image extract
...
out_file = ('/home/xkchen/data/SDSS/member_files/shufl_wBCG_wPA/resamp_img/' + 
