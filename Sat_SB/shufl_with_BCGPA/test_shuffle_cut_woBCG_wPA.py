"""
extract satellite shuffle location images based on resampled image
"""
...
shufl_path = '/home/xkchen/data/SDSS/member_files/shufl_woBCG_wPA/PA_cat/'
...
for dd in range( 3 ):
	...
	for kk in range( 3 ):
		...
		for tt in range( N_shufl ):
			...
			cp_sx, cp_sy, cp_PA = np.array( cat['cp_sx'] ), np.array( cat['cp_sy'] ), np.array( cat['cp_PA2bcg'] )
			...
			keys = [ 'bcg_ra', 'bcg_dec', 'bcg_z', 'sat_ra', 'sat_dec', 'orin_cID', 'orin_Rsat_phy', 
					 'shufl_cID', 'cp_sx', 'cp_sy', 'cp_PA2bcg', 'cp_Rpix', 'cp_Rsat_phy', 'is_symP',
...
out_file = ( '/home/xkchen/data/SDSS/member_files/shufl_woBCG_wPA/resamp_img/' + 
