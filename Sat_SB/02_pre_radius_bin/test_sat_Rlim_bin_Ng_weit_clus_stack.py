"""
stacked cluster image as previous but use the satellite number 
as weight of each cluster. Suppose that, the more satellites,
the brighter of the ICL should be.
"""
