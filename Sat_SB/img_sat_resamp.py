...
### === resampling for satellite images
...
### === resampling for control galaxy images
def contrl_galx_resamp_func(d_file, sub_z, sub_ra, sub_dec, ra_set, dec_set, z_set, img_x, img_y, band, out_file, z_ref, 
	stack_info = None, pixel = 0.396, id_dimm = False):
	"""
	d_file : path where save the masked data (include file-name structure:'/xxx/xxx/xxx.xxx')
	ra_set, dec_set, z_set: ra, dec, z of will be resampled imgs

	sub_z, sub_ra, sub_dec : BCG information~( also the information mapping to image frames)
