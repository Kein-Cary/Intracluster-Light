...
#.
import sys 
sys.path.append('/home/xkchen/project/ICL')
...
# XXX
sub_img = out_path + 'photo-z_match_clust_%s-band_full-BCG' % band_str + '_sub-%d_img.h5'
sub_pix_cont = out_path + 'photo-z_match_clust_%s-band_full-BCG' % band_str + '_sub-%d_pix-cont.h5'
sub_sb = out_path + 'photo-z_match_clust_%s-band_full-BCG' % band_str + '_sub-%d_SB-pro.h5'
# XXX

J_sub_img = out_path + 'photo-z_match_clust_%s-band_full-BCG' % band_str + '_jack-sub-%d_img_z-ref.h5'
J_sub_pix_cont = out_path + 'photo-z_match_clust_%s-band_full-BCG' % band_str + '_jack-sub-%d_pix-cont_z-ref.h5'
J_sub_sb = out_path + 'photo-z_match_clust_%s-band_full-BCG' % band_str + '_jack-sub-%d_SB-pro_z-ref.h5'

jack_SB_file = out_path + 'photo-z_match_clust_%s-band_full-BCG' % band_str + '_Mean_jack_SB-pro_z-ref.h5'
jack_img = out_path + 'photo-z_match_clust_%s-band_full-BCG' % band_str + '_Mean_jack_img_z-ref.h5'
jack_cont_arr = out_path + 'photo-z_match_clust_%s-band_full-BCG' % band_str + '_Mean_jack_pix-cont_z-ref.h5'
...
jack_main_func( id_cen, N_bin, n_rbins, ra, dec, z, clus_x, clus_y, d_file, band_str, 
				...
				jack_SB_file, jack_img, jack_cont_arr, 
