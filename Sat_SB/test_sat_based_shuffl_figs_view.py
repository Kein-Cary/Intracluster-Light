...
out_path = '/home/xkchen/figs/extend_bcgM_cat_Sat/rich_binned/shufl_cat/err_list/'
...
for tt in range( 1 ):
	...
	for dd in range( 20 ):
		...
		##. shuffle list
		cat = pds.read_csv( '/home/xkchen/Downloads/tables/' + 
	...
	plt.savefig('/home/xkchen/clust_%d-%d_%s-band_sat_Rs-PA_comparison.png' % (bin_rich[tt], bin_rich[tt + 1], band_str), dpi = 300)
	plt.close()
