...
for mm in range( 2 ):
	...
	for kk in range( 3 ):
		...
		out_file = out_path + 'nobcg_mask_img/photo-z_mask_%s_ra%.3f_dec%.3f_z%.3f.fits'
...
for mm in range( 2 ):
	...
	for kk in range( 3 ):
		...
		d_file = out_path + 'nobcg_mask_img/photo-z_mask_%s_ra%.3f_dec%.3f_z%.3f.fits'
		out_file = out_path + 'nobcg_resamp_img/photo-z_resamp_%s_ra%.3f_dec%.3f_z%.3f.fits'
