...
##. BG_img stacking
img_path = '/home/xkchen/data/SDSS/member_files/Mrich_binned_shufl_img/resamp_img/'
...
for dd in range( 2 ):
	...
	for ll in range( 3 ):
		...
		for kk in range( 3 ):
			...
			dat = pds.read_csv( cat_path + '%s_clust_rich_%d-%d_rgi-common_frame-lim_Pm-cut_exlu-BCG_sat_%s-band_member_pos-zref.csv' 
								% (cat_lis[dd], bin_rich[ll], bin_rich[ll + 1], band_str),)
			...
			# XXX
			sub_img = out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + '_sub-%d_img.h5'
			sub_pix_cont = out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + '_sub-%d_pix-cont.h5'
			sub_sb = out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + '_sub-%d_SB-pro.h5'
			# XXX

			J_sub_img = out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + '_jack-sub-%d_img_z-ref.h5'
			J_sub_pix_cont = out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + '_jack-sub-%d_pix-cont_z-ref.h5'
			J_sub_sb = out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + '_jack-sub-%d_SB-pro_z-ref.h5'

			jack_SB_file = out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + '_Mean_jack_SB-pro_z-ref.h5'
			jack_img = out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + '_Mean_jack_img_z-ref.h5'
			jack_cont_arr = out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + '_Mean_jack_pix-cont_z-ref.h5'
...
for dd in range( 2 ):
	...
	for ll in range( 3 ):
		...
		for kk in range( 3 ):
			...
			##. N_g for weight
			pat = pds.read_csv( '/home/xkchen/data/SDSS/member_files/Mrich_binned_shufl_img/shufl_cat/' 
								+ '%s_clust_rich_%d-%d_%s-band_sat-shuffle-%d_shufl-sat-Ng.csv' 
								% (cat_lis[dd], bin_rich[ll], bin_rich[ll + 1], band_str, list_order),)
			...
			# XXX
			sub_img = ( out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + 
						'_shufl-%d_BG' % list_order + '_sub-%d_img.h5',)[0]

			sub_pix_cont = ( out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + 
						'_shufl-%d_BG' % list_order + '_sub-%d_pix-cont.h5',)[0]

			sub_sb = ( out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + 
						'_shufl-%d_BG' % list_order + '_sub-%d_SB-pro.h5',)[0]

			# XXX
			J_sub_img = ( out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + 
						'_shufl-%d_BG' % list_order + '_jack-sub-%d_img_z-ref.h5',)[0]

			J_sub_pix_cont = ( out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + 
						'_shufl-%d_BG' % list_order + '_jack-sub-%d_pix-cont_z-ref.h5',)[0]

			J_sub_sb = ( out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + 
						'_shufl-%d_BG' % list_order + '_jack-sub-%d_SB-pro_z-ref.h5',)[0]

			jack_SB_file = ( out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + 
						'_shufl-%d_BG' % list_order + '_Mean_jack_SB-pro_z-ref.h5',)[0]

			jack_img = ( out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + 
						'_shufl-%d_BG' % list_order + '_Mean_jack_img_z-ref.h5',)[0]

			jack_cont_arr = ( out_path + '%s_clust_%s_%s-band' % (cat_lis[dd], sub_name[ ll ], band_str) + 
						'_shufl-%d_BG' % list_order + '_Mean_jack_pix-cont_z-ref.h5',)[0]
	...
	for ll in ( 0,2 ):
		...
		for tt in range( len(R_bins) - 1 ):
			...
			for kk in range( 3 ):
				...
				dat = pds.read_csv( cat_path + '%s_clust_frame-lim_Pm-cut_rich_%d-%d_phyR_%d-%dkpc_mem_%s-band_pos-zref.csv' % 
									( cat_lis[ dd ], bin_rich[ll], bin_rich[ll + 1], R_bins[tt], R_bins[tt + 1], band_str),)
				...
				# XXX
				sub_img = ( out_path + '%s_clust_%s_phyR_%d-%dkpc' % (cat_lis[dd], sub_name[ ll ], R_bins[tt], R_bins[tt + 1]) + 
							'_%s-band' % band_str + '_sub-%d_img.h5',)[0]
				sub_pix_cont = ( out_path + '%s_clust_%s_phyR_%d-%dkpc' % (cat_lis[dd], sub_name[ ll ], R_bins[tt], R_bins[tt + 1]) + 
							'_%s-band' % band_str + '_sub-%d_pix-cont.h5',)[0]
				sub_sb = ( out_path + '%s_clust_%s_phyR_%d-%dkpc' % (cat_lis[dd], sub_name[ ll ], R_bins[tt], R_bins[tt + 1]) + 
							'_%s-band' % band_str + '_sub-%d_SB-pro.h5',)[0]
				# XXX

				J_sub_img = ( out_path + '%s_clust_%s_phyR_%d-%dkpc' % (cat_lis[dd], sub_name[ ll ], R_bins[tt], R_bins[tt + 1]) + 
							'_%s-band' % band_str + '_jack-sub-%d_img_z-ref.h5',)[0]
				J_sub_pix_cont = ( out_path + '%s_clust_%s_phyR_%d-%dkpc' % (cat_lis[dd], sub_name[ ll ], R_bins[tt], R_bins[tt + 1]) + 
							'_%s-band' % band_str + '_jack-sub-%d_pix-cont_z-ref.h5',)[0]
				J_sub_sb = ( out_path + '%s_clust_%s_phyR_%d-%dkpc' % (cat_lis[dd], sub_name[ ll ], R_bins[tt], R_bins[tt + 1]) + 
							'_%s-band' % band_str + '_jack-sub-%d_SB-pro_z-ref.h5',)[0]

				jack_SB_file = ( out_path + '%s_clust_%s_phyR_%d-%dkpc' % (cat_lis[dd], sub_name[ ll ], R_bins[tt], R_bins[tt + 1]) + 
							'_%s-band' % band_str + '_Mean_jack_SB-pro_z-ref.h5',)[0]
				jack_img = ( out_path + '%s_clust_%s_phyR_%d-%dkpc' % (cat_lis[dd], sub_name[ ll ], R_bins[tt], R_bins[tt + 1]) + 
							'_%s-band' % band_str + '_Mean_jack_img_z-ref.h5',)[0]
				jack_cont_arr = ( out_path + '%s_clust_%s_phyR_%d-%dkpc' % (cat_lis[dd], sub_name[ ll ], R_bins[tt], R_bins[tt + 1]) + 
	...
	for ll in ( 0,2 ):
		...
		for tt in range( len(R_bins) - 1 ):
			...
			for kk in range( 3 ):
				...
				##. N_g for weight
				pat = pds.read_csv( cat_path + '%s_clust_frame-lim_Pm-cut_rich_%d-%d_phyR_%d-%dkpc_mem_%s-band_sat-shufl-%d_shufl-Ng.csv' 
									% (cat_lis[dd], bin_rich[ll], bin_rich[ll + 1], R_bins[tt], R_bins[tt + 1], band_str, list_order),)
