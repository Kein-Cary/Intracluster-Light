...
for tt in range( 3 ):
    ...
    # for kk in range( 3 ):
    for kk in range( 1 ):    ###. use r-band for test
        ...
        rand_cat = pds.read_csv( out_path + 
                            ...
                            % (bin_rich[tt], bin_rich[tt + 1], band_str, list_order),)
...
for tt in range( 3 ):
    ...
    for kk in range( 1 ):     ###. use r-band for test
        ...
        ##. satellite table
        dat = pds.read_csv( cat_path + 'clust_rich_%d-%d_rgi-common_frame-lim_lower-Pm_sat_%s-band_member_pos.csv' 
