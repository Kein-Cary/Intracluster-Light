...
##.. data load
dat = pds.read_csv( load + 'Extend_Mbcg_rich_rebin_sat_cat/Extend-BCGM_rgi-common_frame-lim_lower-Pm_member-cat.csv' )
...
for tt in range( 3 ):
	...
	dat = pds.read_csv( load + 'Extend_Mbcg_rich_rebin_sat_cat/Extend-BCGM_rgi-common_frame-lim_lower-Pm_member_%s-band_pos.csv' % band_str )
	...
	d_file = home + 'member_files/sat_woBCG/mask_imgs/Sat-tract_%s-band_clus_ra%.3f_dec%.3f_z%.3f_sat_ra%.4f_dec%.4f_mask-img.fits'
