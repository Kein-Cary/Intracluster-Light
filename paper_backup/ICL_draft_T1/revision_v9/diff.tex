...
%DIF DEL ../revision_v8/ms.tex   Thu Mar 31 03:12:24 2022
%DIF ADD ms.tex                  Thu Mar 31 23:45:46 2022
...
bandpass\DIFaddbegin \DIFadd{~\mbox{%DIFAUXCMD
\citep[but see][]{Bernardi2017}}\hspace{0pt}%DIFAUXCMD
...
\caption{\DIFaddFL{Impact of the SDSS PSF on the BCG+ICL SB profiles.  }{\it \DIFaddFL{Top}}\DIFaddFL{:
...
convolving them with the PSF derived by \mbox{%DIFAUXCMD
\citet{Infante-Sainz2020} }\hspace{0pt}%DIFAUXCMD
in each
band~(illustrated in the inset panel, where the PSF in each band is
    normalized to have unit total flux). }{\it \DIFaddFL{Bottom}}\DIFaddFL{: The ratio between
...
\DIFaddend To further remove any contamination by bright stars and extended sources
...
\DIFaddbegin \DIFadd{We explicitly test this using the colours of the BCGs to compute the
...
surface density profiles. }\DIFaddend In addition, we correct for Galactic extinction
on the stacked images \DIFaddbegin \DIFadd{using the average $A_v$ of the BCG sightlines}\DIFaddend , rather
than the individual \DIFdelbegin \DIFdel{images}\DIFdelend \DIFaddbegin \DIFadd{BCGs}\DIFaddend . Secondly, we resample all the rescaled images to
...
images centred on the BCGs in physical coordinates. We \DIFaddbegin \DIFadd{do not rotate the
...
We }\DIFaddend carefully account for the masked regions and adopt the mean flux at each
...
background galaxies, \DIFdelbegin \DIFdel{and foreground stars~(i.e., }\DIFdelend \DIFaddbegin \DIFadd{foreground stars, and the Galactic cirrus~(which is
uncorrelated with the cluster positions on the sky), hence a
}\DIFaddend BCG+ICL+Background \DIFdelbegin \DIFdel{).
}\DIFdelend \DIFaddbegin \DIFadd{SB profile.
. }\DIFaddend We will estimate the unmasked satellite contribution by inspecting
the satellite stellar mass functions later in \S\ref{subsec:budget}, and
describe the removal of the background SB induced by the other \DIFdelbegin \DIFdel{two }\DIFdelend \DIFaddbegin \DIFadd{three
}\DIFaddend components below.
...
dividing each cluster sample into 30 equal-size subsamples, and \DIFdelbegin \DIFdel{compute }\DIFdelend \DIFaddbegin \DIFadd{estimate
}\DIFaddend the error matrix from the 30 ``leave-one-out''\DIFdelbegin \DIFdel{measurements~}\DIFdelend \DIFaddbegin \DIFadd{~(i.e., using 29 subsamples
for each resampled measurement) experiments~}\DIFaddend \citep{Efron1981}.
...
\DIFaddbegin \DIFadd{Note that none of the BCG+ICL SB profile measurements shown in
Figure~\ref{fig:Z05_comparison} are corrected for the wide-angle effect of
the PSF~\mbox{%DIFAUXCMD
\citep{Tal2011, D'Souza2014, Wang2019}}\hspace{0pt}%DIFAUXCMD
. To test the impact of PSF
on the diffuse light on large scales, \mbox{%DIFAUXCMD
\citet{Zhang2019} }\hspace{0pt}%DIFAUXCMD
fit a model with
...
\mbox{%DIFAUXCMD
\citet{Infante-Sainz2020}}\hspace{0pt}%DIFAUXCMD
. Figure~\ref{fig:SB_convo_psf} compares the
...
\mbox{%DIFAUXCMD
\citet{Infante-Sainz2020}}\hspace{0pt}%DIFAUXCMD
, normalized so that total flux is unity in each
...
%DIF >  PSF convolution is
%DIF >  negligible outside $100\,\kpc$ at redshift 0.25.
}


%DIF >  \subsection{PSF Impacts}
%DIF >  \label{subsec:psfaffect}
%DIF >  The extended wings of point spread function~(PSF) is always a issue of low surface brightness measurement~(ref. list).
...
$0.148\%$~(ICL). \DIFaddbegin \DIFadd{Using the DES imaging, \mbox{%DIFAUXCMD
\citet{Zhang2019} }\hspace{0pt}%DIFAUXCMD
estimated that
...
lower end of the \mbox{%DIFAUXCMD
\citet{Zhang2019} }\hspace{0pt}%DIFAUXCMD
estimation.
}\DIFaddend
...
explanation of such observation, see ~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citet{Zu2021b}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{Zu2022}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend ).
...
scales\DIFaddbegin \DIFadd{~\mbox{%DIFAUXCMD
\citep{Kelson2002, Bender2015, Veale2018}}\hspace{0pt}%DIFAUXCMD
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Bender}}{{Bender}}{2015}]{Bender2015} {Bender}\DIFadd{, Ralf and }{\DIFadd{Kormendy}}\DIFadd{, John and }{\DIFadd{Cornell}}\DIFadd{, Mark E. and }{\DIFadd{Fisher}}\DIFadd{, David B.  }\mn@doi [\apj] {10.1088/0004-637X/807/1/56}\DIFadd{, }\href
{https://ui.adsabs.harvard.edu/abs/2015ApJ...807...56B} {807, 56}

\DIFaddend \bibitem[\protect\citeauthoryear{{Bernardi}, {Meert}, {Sheth}, {Vikram},
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Bernardi}}{{Bernardi}}{2017}]{Bernardi2017} {Bernardi}\DIFadd{, M. and }{\DIFadd{Meert}}\DIFadd{, A. and }{\DIFadd{Sheth}}\DIFadd{, R.~K. and }{\DIFadd{Fischer}}\DIFadd{, J. -L. and }{\DIFadd{Huertas-Company}}\DIFadd{, M. and }{\DIFadd{Maraston}}\DIFadd{, C. and }{\DIFadd{Shankar}}\DIFadd{, F. and }{\DIFadd{Vikram}}\DIFadd{, V. }\mn@doi [\mnras] {10.1093/mnras/stx176}\DIFadd{, }\href
{https://ui.adsabs.harvard.edu/abs/2017MNRAS.467.2217B} {467, 2217}


\DIFaddend \bibitem[\protect\citeauthoryear{{Bertin} \& {Arnouts}}{{Bertin} \&
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{D'Souza}}{{D'Souza}}{2014}]{D'Souza2014} {D'Souza}\DIFadd{, Richard and }{\DIFadd{Kauffman}}\DIFadd{, Guinevere and }{\DIFadd{Wang}}\DIFadd{, Jing and }{\DIFadd{Vegetti}}\DIFadd{, Simona  }\mn@doi [\mnras] {10.1093/mnras/stu1194}\DIFadd{, }\href
{https://ui.adsabs.harvard.edu/abs/2014MNRAS.443.1433D} {443, 1443}


\DIFaddend \bibitem[\protect\citeauthoryear{Efron \& Stein}{Efron \&
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Infante-Sainz}}{{Infante-Sainz}}{2020}]{Infante-Sainz2020} {Infante-Sainz}\DIFadd{, Ra}{\DIFadd{\'u}}\DIFadd{l and }{\DIFadd{Trujillo}}\DIFadd{, Ignacio and }{\DIFadd{Rom}{\DIFadd{\'a}}\DIFadd{n}}\DIFadd{, Javier,  2020, }\mn@doi [\mnras] {10.1093/mnras/stz3111}\DIFadd{, }\href
{https://ui.adsabs.harvard.edu/abs/2020MNRAS.491.5317I} {491, 5317}


\DIFaddend \bibitem[\protect\citeauthoryear{{Ivezi{\'c}} et~al.,}{{Ivezi{\'c}}
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Kelson}}{{Kelson}}{2002}]{Kelson2002} {Kelson}\DIFadd{, Daniel D. and }{\DIFadd{Zabludoff}}\DIFadd{, Ann I. and }{\DIFadd{Williams}}\DIFadd{, K.~A. and }{\DIFadd{Trager}}\DIFadd{, S.~C. and }{\DIFadd{Mulchaey}}\DIFadd{, J.~S. and }{\DIFadd{Bolte}}\DIFadd{, Michael  }\mn@doi [\apj] {10.1086/341891}\DIFadd{, }\href {https://ui.adsabs.harvard.edu/abs/2002ApJ...576..720K} {576, 720}

\DIFaddend \bibitem[\protect\citeauthoryear{{Kluge}, {Bender}, {Riffeser}, {Goessl},
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Tal}}{{Tal}}{2011}]{Tal2011} {Tal}\DIFadd{, Tomer and }{\DIFadd{van Dokkum}}\DIFadd{, Pieter G. }\mn@doi [\apj] {10.1088/0004-637X/731/2/89}\DIFadd{, }\href
{https://ui.adsabs.harvard.edu/abs/2011ApJ...731...89T} {731, 89}

\DIFaddend \bibitem[\protect\citeauthoryear{{Tang}, {Lin}, {Cui}, {Kang}, {Wang},
...
\DIFaddbegin \bibitem[\protect\citeauthoryear{{Veale}}{{Veale}}{2018}]{Veale2018} {Veale}\DIFadd{, Melanie and }{\DIFadd{Ma}}\DIFadd{, Chung-Pei and }{\DIFadd{Greene}}\DIFadd{, Jenny E. and }{\DIFadd{Thomas}}\DIFadd{, Jens and }{\DIFadd{Blakeslee}}\DIFadd{, John P. and }{\DIFadd{Walsh}}\DIFadd{, Jonelle L. and }{\DIFadd{Ito}}\DIFadd{, Jennifer }\mn@doi [\mnras] {10.1093/mnras/stx2717}\DIFadd{, }\href
{https://ui.adsabs.harvard.edu/abs/2018MNRAS.473.5446V} {473, 5446}


\bibitem[\protect\citeauthoryear{{Wang}}{{Wang}}{2019}]{Wang2019} {Wang}\DIFadd{, Wenting and }{\DIFadd{Han}}\DIFadd{, Jiaxin and }{\DIFadd{Sonnenfeld}}\DIFadd{, Alessandro and }{\DIFadd{Yasuda}}\DIFadd{, Naoki and }{\DIFadd{Li}}\DIFadd{, Xiangchong and }{\DIFadd{Jing}}\DIFadd{, Yipeng and }{\DIFadd{More}}\DIFadd{, Surhud and }{\DIFadd{Price}}\DIFadd{, Paul A. and }{\DIFadd{Lupton}}\DIFadd{, Robert and }{\DIFadd{Rykoff}}\DIFadd{, Eli S. and }{\DIFadd{Stark}}\DIFadd{, David V. and }{\DIFadd{Lan}}\DIFadd{, Ting-Wen and }{\DIFadd{Takada}}\DIFadd{, Masahiro and }{\DIFadd{Huang}}\DIFadd{, Song and }{\DIFadd{Luo}}\DIFadd{, Wentao and }{\DIFadd{Bahcall}}\DIFadd{, Neta A. and }{\DIFadd{Komiyama}}\DIFadd{, Yutaka  }\mn@doi [\mnras] {10.1093/mnras/stz1339}\DIFadd{, }\href {https://ui.adsabs.harvard.edu/abs/2019MNRAS.487.1580W} {487, 1580}

\bibitem[\protect\citeauthoryear{{Wang}}{{Wang}}{2021}]{Wang2021} {Wang}\DIFadd{, Wenting and }{\DIFadd{Li}}\DIFadd{, Xiangchong and }{\DIFadd{Shi}}\DIFadd{, Jingjing and }{\DIFadd{Han}}\DIFadd{, Jiaxin and }{\DIFadd{Yasuda}}\DIFadd{, Naoki and }{\DIFadd{Jing}}\DIFadd{, Yipeng and }{\DIFadd{More}}\DIFadd{, Surhud and }{\DIFadd{Takada}}\DIFadd{, Masahiro and }{\DIFadd{Miyatake}}\DIFadd{, Hironao and }{\DIFadd{Nishizawa}}\DIFadd{, Atsushi J.  }\mn@doi [\apj] {10.3847/1538-4357/ac0e38}\DIFadd{, }\href {https://ui.adsabs.harvard.edu/abs/2021ApJ...919...25W} {919, 25}

\DIFaddend \bibitem[\protect\citeauthoryear{Welch \& Sastry}{1971}]{Welch1971} Welch G.~A., Sastry G.~N., 1971, ApJL, 169, L3. doi:10.1086/180801
...
\DIFdelbegin %DIFDELCMD < \bibitem[\protect\citeauthoryear{{Zu} et~al.,}{{Zu} et~al.}{2021a}]{Zu2021}
%DIFDELCMD < {Zu} %%%
\DIFdelend \DIFaddbegin \bibitem[\protect\citeauthoryear{{Zu} et~al.,}{{Zu} et~al.}{2021}]{Zu2021}
{Zu} \DIFaddend Y.,  et~al., \DIFdelbegin \DIFdel{2021a}\DIFdelend \DIFaddbegin \DIFadd{2021}\DIFaddend , \mn@doi [\mnras] {10.1093/mnras/stab1712}, \href
  {https://ui.adsabs.harvard.edu/abs/2021MNRAS.505.5117Z} {505, 5117}

\DIFdelbegin %DIFDELCMD < \bibitem[\protect\citeauthoryear{{Zu} et~al.,}{{Zu} et~al.}{2021b}]{Zu2021b}
%DIFDELCMD < {Zu} %%%
\DIFdelend \DIFaddbegin \bibitem[\protect\citeauthoryear{{Zu} et~al.,}{{Zu} et~al.}{2022}]{Zu2022}
{Zu} \DIFaddend Y.,  et~al., \DIFdelbegin \DIFdel{2021b, arXiv e-prints, }%DIFDELCMD < \href
%DIFDELCMD <   {https://ui.adsabs.harvard.edu/abs/2021arXiv210806790Z} {p. arXiv:2108.06790}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \DIFadd{2022, }\mn@doi [\mnras] { 10.1093/mnras/stac125}\DIFadd{, }\href
